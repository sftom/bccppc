...
As atividades de extensão do curso de \acrshort{bcc}, seguem a Resolução UFAPE/CONSEPE nº XXXXX/2022, de DD/MM/2022, que dispõe sobre a Integralização das Atividades de Extensão como componente curricular dos Cursos de Graduação da \acrfull{ufape}.
...
\begin{itemize}
    ...
    \item O Projeto ou Programa pode, em sua elaboração, prever a realização de Cursos, Eventos e Prestação de Serviço.
    \item Em Projetos ou Programas em andamento poderão ser vinculados Cursos, Eventos e Prestação de Serviço posteriormente à institucionalização na \acrshort{ufape}, desde que seja informada no relatório parcial ou final.
\end{itemize}
