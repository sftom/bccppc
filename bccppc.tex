...
\begin{itemize}
  ...
  \item 320 horas em atividades complementares, ver Quadro~\ref{tab:atividadescomplementares}, pág.~\pageref{tab:atividadescomplementares}.
...
A critério do aluno, outras disciplinas complementares, optativas e eletivas (todas as disciplinas ofertadas na UFRPE são consideradas eletivas para o aluno do Bacharelado em Ciência da Computação, desde que aprovadas pelo Colegiado do Curso) poderão ser incorporadas ao seu histórico escolar. Contudo, as eletivas não são contabilizadas para integralização do currículo de créditos. Os prazos de conclusão de curso estão sumarizados na Quadro~\ref{tab:prazoCurriculo}, a seguir. 
...
Créditos, correspondente ao aprovado, considerando a Quadro~\ref{tab:atividadescomplementares} reproduzida aqui.
